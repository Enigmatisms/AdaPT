...
if __name__ == "__main__":
    ...
    emitter_configs, array_info, all_objs, bxdfs, configs = scene_parsing(input_folder, opts.name)  # complex_cornell
    ...
    rdr: PathTracer = rdr_mapping[opts.type](emitter_configs, array_info, bxdfs, all_objs, configs)
