...
class PhaseFunction:
    ...
    @ti.func
    def sample_p(self, _type: int, incid: vec3):
        """ 
    ...
    def eval_p(self, _type: int, ray_in: vec3, ray_out: vec3):
        ...
        if _type == 0:             # H-G: FIXME: single H-G has no spectral differences
